...
template <typename T> void debug_one(T t);
...
template <typename T> void debug_itr(const T items[], int len, int split = 0) {
...
template <typename T> void debug_one(T t) { debug_one_helper(t); }
